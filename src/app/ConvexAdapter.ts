...
import { Id, Doc } from '@src/convex/_generated/dataModel';
...
export const ConvexAdapter: Adapter = {
  async createAuthenticator(authenticator: Authenticator) {
    ...
    await callMutation(api.authAdapter.createAuthenticator, {
      authenticator: { ...rest, transports: transports ?? undefined },
    });
...
function callQuery<Query extends FunctionReference<'query'>>(query: Query, args: Omit<FunctionArgs<Query>, 'secret'>) {
